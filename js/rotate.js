  ...
  $.fn.roate = function (options) {
    ...
    var _init = function () {
      ...
      _setEventBind = function () {
        $(options.nextButton).on('click.roate', function () {
          pm.next();
        });

        $(options.prevButton).on('click.roate', function () {
          pm.prev();
        });

        $(options.playButton).on('click.roate', function () {
          _stopTimer();
          pm.play();
        });

        $(options.stopButton).on('click.roate', function () {
          pm.stop();
        });
        $this.hover(
          function () {
