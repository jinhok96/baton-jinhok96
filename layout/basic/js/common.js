...
// 공통레이어팝업 오픈
var globalLayerOpenFunc = function (_elem) {
  this.id = $(_elem).data('id');
  this.param = $(_elem).data('param');
  this.basketType = $('#basket_type').val();
  this.url = $(_elem).data('url');
        ...
        if (data.indexOf('404 페이지 없음') == -1) {
          ...
          var $layer = $('<div>', {
            html: $('<iframe>', {
              ...
              scrolling: 'auto',
              css: { width: '100%', height: '100%', overflowY: 'auto', border: 0 },
            }),
            id: _this.layerId,
